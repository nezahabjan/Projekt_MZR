# tu je ui funkcija, ki se kliče v datoteki zagon.R
              ...
              conditionalPanel(
                ...
                conditionalPanel(condition = "input.polnost == '1'",
                                 numericInput(inputId = "vozl_1",
                                              label = "Izberi število vozlišč grafa",
                                              value = 0 )),
    ...
    tabItem(tabName = "lastnosti",
            ...
            fluidRow(sidebarPanel(
              ...
              conditionalPanel(
                ...
                p("Najprej mi moraš podati začetek in konec željene poti"),
                numericInput(inputId = "zacni", "Vnesi številko vozlišča, ki naj bo začetek poti.", value = 0, min=0),
                numericInput(inputId = "finish", "Vnesi številko vozlišča, ki naj bo konec poti.", value = 0, min=0),
                p("Sedaj pa povezavam v grafu določi cene. Vsaka povezava iz spodnjega seznama naj dobi svojo vrednost! Če cen ne želiš prosim vpiši besedico 'NULL'"),
                htmlOutput("povezave_2"),
                textInput("utezi_2", "Vnesi celoštevilske vrednosti, ločene z vejico.", value="")
              ),
              ...
              conditionalPanel(
                ...
                htmlOutput("edges_3"),
                textInput("utezi_3", "Vnesi celoštevilske vrednosti, ločene z vejico.", value="")
              ),
              
              conditionalPanel(
                condition = "input.characteristic =='12'",
                p("Za preverjanje grafičnosti poljubnega zaporedja najprej določi, ali preverjaš grafičnost za usmerjen ali neusmerjen graf."),
                selectInput("graficnost", "Izberi usmerjenost potencialnega grafa!",choices = c("usmerjen"=1,
                                                                                                "neusmerjen"=2,
                                                                                                "/"=3), selected =3),
                conditionalPanel(
                  condition= "input.graficnost == 1",
                  textInput("in_stopnje", "Vnesi zaporedje vhodnih stopenj, ločenih z vejico.", value=""),
                  textInput("out_stopnje", "Vnesi zaporedje izhodnih stopenj, ločenih z vejico.", value=""),
                  textOutput("preveri_stopnje")
                ),
                conditionalPanel(
                  condition= "input.graficnost == 2",
                  textInput("stopnje", "Vnesi zaporedje stopenj, ločenih z vejico.", value="")
                )
              ),
            ...
            box( title = "Rezultat poizvedbe", status = "success",
              ...
              conditionalPanel(
                ...
                p("Bi rad povezavni graf tvojega grafa uporabljal še naprej?"),
              ...
              conditionalPanel(
                ...
                p("Bi rad komplementarni graf tvojega grafa uporabljal še naprej?"),
    ...
    tabItem(tabName = "problemi",
            ...
            fluidRow(sidebarPanel(
              ...
              box (width=12, title = "REŠEVANJE", status = "primary",
                ...
                p("Za začetek reševanja problema trgovskega potnika, moraš povezavam določiti uteži. Te lahko predstavljajo ceno vožnje, porabljen čas, energijo, količino nafte,..."),
                ...
                textOutput("text_13"),
                numericInput("start", "Vnesi vozlišče, kjer naj trgovski potnik začne s potjo!", value=0, min=0),
                textOutput("text_14"),
